...
import { APP_LOCAL_HOST, APP_URL } from '../Variables/Variables';
import { getUserFavouriteData } from '../Redux/UserFavouriteReducer/action';


export const ThreeDotsUserFavourites = ({id}) => {
    ...
    const DeleteUserPost = () => {
        ...
        axios.delete(`${APP_URL}/post/userFavourite/delete/${id}`, { headers })
            .then((res) => {
                console.log(res);
                toast({
